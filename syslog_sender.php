...
<head>
    ...
    <title>Générateur de Messages Syslog</title>
...
<body>
    <div class="container my-5">
        <div class="card">
            <div class="card-body">
                ...
                <div class="alert alert-info d-flex align-items-center" role="alert">
                    ...
                    <div>
                        <strong>Information:</strong> Ce script permet de composer et d'envoyer des messages au format Syslog (RFC 3164) vers un serveur Syslog distant.
                    </div>
                </div>
                ...
                <form method="POST" action="" id="syslogForm">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="syslog_server" class="form-label">Serveur Syslog <span class="text-danger">*</span></label>
                            ...
                            <div class="form-text">Adresse IP ou nom d'hôte du serveur Syslog</div>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="syslog_port" class="form-label">Port Syslog <span class="text-danger">*</span></label>
                            ...
                            <div class="form-text">Port standard: 514 (UDP) / 601 ou 1468 (TCP)</div>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="protocol" class="form-label">Protocole <span class="text-danger">*</span></label>
                            ...
                            <div class="form-text">UDP: rapide, sans garantie / TCP: fiable, avec connexion</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text">Code de la source du message (0-23)</div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text">Niveau de gravité du message (0-7)</div>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="hostname" class="form-label">Hostname Source <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="hostname" name="hostname" 
                                   value="<?php echo isset($_POST['hostname']) ? htmlspecialchars($_POST['hostname']) : gethostname(); ?>" 
                                   maxlength="255" required>
                            <div class="form-text">Nom d'hôte source du message (max 255 caractères)</div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text">Nom de l'application (lettres, chiffres, _, - seulement)</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="process_id" name="process_id" 
                                   ...
                                   min="1" max="65535">
                            <div class="form-text">ID du processus (optionnel, 1-65535)</div>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="timestamp_format" class="form-label">Format Timestamp</label>
                            <select name="timestamp_format" id="timestamp_format" class="form-select">
                                ...
                                $timestamp_formats = [
                                    ...
                                    'custom' => 'Personnalisé (Y-m-d H:i:s)'
                                ];
                            ...
                            <div class="form-text">Format de l'horodatage</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            Contenu du message (max 1024 caractères) - 
                            <span id="charCount">0</span>/1024 caractères
                        </div>
                    </div>
                ...
                <?php
                /**
                 * Fonction pour formater le timestamp selon le format choisi
                 */
                ...
                /**
                 * Fonction pour créer un message Syslog au format RFC 3164
                 */
                function createSyslogMessage($facility, $severity, $hostname, $app_name, $process_id, $message, $timestamp_format) {
                    // Calcul de la priorité: Priority = Facility * 8 + Severity
                    $priority = ($facility * 8) + $severity;
                    
                    // Formatage du timestamp
                    $timestamp = formatTimestamp($timestamp_format);
                    
                    // Construction du tag (APP_NAME[PID])
                    $tag = $app_name;
                    if (!empty($process_id)) {
                        $tag .= '[' . $process_id . ']';
                    }
                    
                    // Construction du message au format RFC 3164: <Priority>Timestamp Hostname Tag: Message
                ...
                /**
                 * Fonction pour envoyer le message Syslog via UDP ou TCP
                 */
                function sendSyslogMessage($server, $port, $message, $protocol = 'udp') {
                    if ($protocol === 'tcp') {
                        ...
                        if ($socket === false) {
                            return [
                                'success' => false,
                                'error' => 'Impossible de créer le socket TCP: ' . socket_strerror(socket_last_error())
                            ];
                        }
                        ...
                        if ($connect === false) {
                            ...
                            return [
                                'success' => false,
                                'error' => 'Impossible de se connecter au serveur TCP: ' . $error
                            ];
                        }
                        
                        // Envoi du message (TCP nécessite souvent un terminateur de ligne)
                        ...
                        if ($result === false) {
                            ...
                            return [
                                'success' => false,
                                'error' => 'Erreur lors de l\'envoi TCP: ' . $error
                            ];
                        }
                        ...
                        // UDP: socket de datagramme
                        $socket = socket_create(AF_INET, SOCK_DGRAM, SOL_UDP);
                        
                        if ($socket === false) {
                            return [
                                'success' => false,
                                'error' => 'Impossible de créer le socket UDP: ' . socket_strerror(socket_last_error())
                            ];
                        }
                        ...
                        if ($result === false) {
                            ...
                            return [
                                'success' => false,
                                'error' => 'Erreur lors de l\'envoi UDP: ' . $error
                            ];
                        }
                ...
                if (isset($_POST['send_message']) || isset($_POST['preview_message'])) {
                    ...
                    if (strlen($hostname) > 255) {
                        $errors[] = 'Le hostname ne doit pas dépasser 255 caractères.';
                    }
                    
                    if (strlen($app_name) > 48) {
                        $errors[] = 'Le nom de l\'application ne doit pas dépasser 48 caractères.';
                    }
                    
                    if (strlen($message) > 1024) {
                        $errors[] = 'Le message ne doit pas dépasser 1024 caractères.';
                    }
                    ...
                    if (empty($errors)) {
                        ...
                        echo '<strong>Prévisualisation du message Syslog</strong>';
                        echo '</div>';
                        ...
                        echo '</div>';
                        echo '<div class="col-md-6">';
                        echo '<strong>Taille:</strong> <span class="badge bg-info info-badge">' . strlen($syslog_message) . ' octets</span>';
                        echo '</div>';
                        echo '</div>';
                        ...
                        echo '<strong>Message formaté:</strong>';
                        echo '<div class="syslog-preview">' . htmlspecialchars($syslog_message) . '</div>';
                        echo '</div>';
                        echo '</div>';
                        
                        // Envoi du message si le bouton "Envoyer" a été cliqué
                        if (isset($_POST['send_message'])) {
                            ...
                            if ($result['success']) {
                                ...
                                echo 'Serveur: ' . htmlspecialchars($syslog_server) . ':' . $syslog_port . '<br>';
                                echo 'Octets envoyés: ' . $result['bytes_sent'] . '<br>';
                                ...
                                echo '<div>';
                                echo '<strong>Erreur lors de l\'envoi du message</strong><br>';
                        ...
                        echo '<i class="bi bi-exclamation-triangle-fill me-2 flex-shrink-0" style="font-size: 1.25rem;"></i>';
                        echo '<div>';
                        echo '<strong>Erreurs de validation:</strong><ul class="mb-0">';
                ...
                <div class="mt-4">
                    <h2 class="h5">Documentation Syslog</h2>
                    <div class="accordion" id="syslogDocs">
                        <div class="accordion-item">
                            ...
                            <div id="facilityDocs" class="accordion-collapse collapse" data-bs-parent="#syslogDocs">
                                <div class="accordion-body">
                                    <p>Les Facilities identifient la source du message:</p>
                                    <ul>
                                        <li><strong>0-15:</strong> Facilities système standard</li>
                                        <li><strong>16-23:</strong> Local0 à Local7 (usage personnalisé)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="severityDocs" class="accordion-collapse collapse" data-bs-parent="#syslogDocs">
                                <div class="accordion-body">
                                    <p>Les Severities indiquent le niveau de gravité:</p>
                                    <ul>
                            ...
                            <div id="formatDocs" class="accordion-collapse collapse" data-bs-parent="#syslogDocs">
                                <div class="accordion-body">
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>Hostname:</strong> Nom de la machine source</li>
                                        <li><strong>Tag:</strong> Application[PID]</li>
                                        <li><strong>Message:</strong> Contenu du message (max 1024 caractères)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="text-center mt-3 text-muted">
            <small>Générateur de Messages Syslog - RFC 3164 & RFC 5424 - <?php echo date('Y'); ?></small>
        </div>
    </div>
